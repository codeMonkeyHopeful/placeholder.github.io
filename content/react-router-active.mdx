...
summary: "In this tutorial, we will show you how to create an active page in React Router."
...
In this example, we've created two NavLink components, one for each page in our application. We've also added the <span className="text-blue-500">getClassName function</span> class to each NavLink, which will add the "active" class to the link when the corresponding page is active.
